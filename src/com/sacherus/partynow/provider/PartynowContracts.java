 ...
 * the provider API.
 */
public class PartynowContracts {
	...
	public static final class PartyColumnHelper implements BaseColumns {
		...
		public static final Uri PARTIES_URI_REST = Uri.withAppendedPath(PartyColumnHelper.PARTIES_URI,
				PartynowContracts.URI_REST_FLAG);
		...
		public static final String URI_PARTY_NAME_REST = URI_PARTY_NAME + "/" + PartynowContracts.URI_REST_FLAG;
